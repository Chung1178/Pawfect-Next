...
// 社群連結資料
const socialLinks = [
  { href: 'https://www.facebook.com/', src: '/layout/facebook-footer.svg', alt: 'facebook-icon' },
  { href: 'https://x.com/', src: '/layout/twitter-footer.svg', alt: 'twitter-icon' },
  { href: 'https://www.instagram.com/', src: '/layout/ig-footer.svg', alt: 'instagram-icon' },
];
    ...
    <footer className={`footer ${styles['bg-gradient-thirdly']} py-9 py-lg-17`}>
      <div className="container">
            ...
            <div className="row">
              {navLinks.map((link) => (
                <div className="col-6 col-md-auto mb-5 mb-md-0" key={link.text}>
                  <Link href={link.href} className="text-light fs-10 fs-md-9 opacity-70-hover transition-base">
                    {link.text}
                  </Link>
                </div>
              ))}
        ...
        <div className="d-md-flex justify-content-md-between pb-6 pb-md-11 border-bottom border-light">
          <div className="d-md-flex">
            <div className="text-light fs-10 fs-md-9 mb-5 mb-md-0 me-md-9">
              ...
              <a href="mailto:pawfectcare@gmail.com" className="text-light opacity-70-hover transition-base">
                pawfectcare@gmail.com
              </a>
            </div>
            <div className="text-light fs-10 fs-md-9">
              <p className="fw-bold mb-1">電話</p>
              <a href="tel:02-1234-5678" className="text-light opacity-70-hover transition-base">
                02-1234-5678
              </a>
            </div>
          </div>
        ...
        <div className="pt-6 pt-md-11 text-light text-center">
          <p className="fs-11 fs-md-10 mb-0">© 2024 Pawfect Care. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
